# -*- coding: utf-8 -*-
"""
Created on Thu May 25 14:36:43 2023
...
for dataset_name, dataset in datasets.items():
    ...
    classifiers = {
        'Logistic Regression': LogisticRegression(class_weight='balanced', random_state=42, max_iter=1000000),
        'Random Forest': RandomForestClassifier(class_weight='balanced', random_state=42),
        'XGBoost': XGBClassifier(scale_pos_weight=len(y_train[y_train==0])/len(y_train[y_train==1]), random_state=42),
        'Neural Network': MLPClassifier(random_state=42, max_iter=1000000)
    }
...
results_df.to_excel('C:/Users/Jianwei Peng/Desktop/新建文件夹/Results/Cost-sensitive learning auc results.xlsx')
