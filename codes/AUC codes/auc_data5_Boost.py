# -*- coding: utf-8 -*-
"""
Created on Fri Jun  9 01:42:23 2023
...
df = pd.read_csv('C:/Users/Jianwei Peng/Desktop/新建文件夹/Handled datasets/credit card_0-1-2-3_data5.csv')
...
samplers = [
    SMOTETomek(),
    SMOTENC(categorical_features=[0,1,2,3,4,5]),
    ADASYN(),
...
df_results.to_excel('C:/Users/Jianwei Peng/Desktop/新建文件夹/Results/Boosting results/auc_data5_Boost.xlsx', index=False)
