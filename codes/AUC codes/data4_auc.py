# -*- coding: utf-8 -*-
"""
Created on Wed Apr 26 17:57:30 2023
...
classifiers = [
    LogisticRegression(class_weight='balanced', random_state=42, max_iter=10000000),
    RandomForestClassifier(class_weight='balanced', random_state=42),
    XGBClassifier(scale_pos_weight=len(y_train[y_train==0])/len(y_train[y_train==1]), random_state=42),
    MLPClassifier(random_state=42, max_iter=10000,hidden_layer_sizes=(2000,))
]
