# -*- coding: utf-8 -*-
"""
Created on Fri Jun  9 01:36:04 2023
...
df = pd.read_csv('C:/Users/Jianwei Peng/Desktop/新建文件夹/Handled datasets/prosperLoanData_data2.csv')
...
samplers = [
    SMOTETomek(),
    SMOTENC(categorical_features=[9,11,12,35]),
    ADASYN(),
...
df_results.to_excel('C:/Users/Jianwei Peng/Desktop/新建文件夹/Results/Boosting results/auc_data2_Boost.xlsx', index=False)
