# -*- coding: utf-8 -*-
"""
Created on Mon Apr  3 23:42:52 2023
...
classifiers = [
    ...
    OneVsOneClassifier(MLPClassifier(max_iter=10000,hidden_layer_sizes=(1000,))),
    OneVsRestClassifier(LogisticRegression(max_iter=100000)),
    OneVsRestClassifier(RandomForestClassifier()),
    OneVsRestClassifier(XGBClassifier()),
    OneVsRestClassifier(MLPClassifier(max_iter=10000,hidden_layer_sizes=(1000,)))
]
