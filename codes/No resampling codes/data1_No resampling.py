# -*- coding: utf-8 -*-
"""
Created on Wed Mar 15 22:25:21 2023
...
classifiers = [
    ...
    OneVsOneClassifier(MLPClassifier(max_iter=3000,hidden_layer_sizes=(1000,))),
    OneVsRestClassifier(LogisticRegression(max_iter=100000)),
    OneVsRestClassifier(RandomForestClassifier()),
    OneVsRestClassifier(XGBClassifier()),
    OneVsRestClassifier(MLPClassifier(max_iter=3000,hidden_layer_sizes=(1000,)))
]
