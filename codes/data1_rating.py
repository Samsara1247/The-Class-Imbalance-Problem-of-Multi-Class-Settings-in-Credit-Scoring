# -*- coding: utf-8 -*-
"""
Created on Mon Apr  3 23:13:23 2023
...
classifiers = [
    ...
    OneVsOneClassifier(MLPClassifier(random_state=42, max_iter=3000,hidden_layer_sizes=(1000,))),
    ...
    OneVsRestClassifier(MLPClassifier(random_state=42, max_iter=3000,hidden_layer_sizes=(1000,)))
]

# Defining the sampling techniques
samplers = [
    SMOTETomek(smote=SMOTE(k_neighbors=1)),
    SMOTE(k_neighbors=1),
    ADASYN(n_neighbors = 1, sampling_strategy=str('minority')),
    NeighbourhoodCleaningRule(sampling_strategy=str('majority')),
    OneSidedSelection(sampling_strategy=str('majority'))
]
...
df_results.to_excel('C:/Users/Jianwei Peng/Desktop/新建文件夹/Results/Results of data1.xlsx', index=False)
